...
const GOVERNMENT: ForgeChoice[] = [
  ...
  {
    id: "gov-improvised",
    label: "Underfunded governance (improvised)",
    cost: 0,
    blurb: "Patchwork authority; bank points, pay in legitimacy and control.",
  },
];
...
const ECONOMY: ForgeChoice[] = [
  ...
  {
    id: "econ-improvised",
    label: "Underfunded economy (informal / patchwork)",
    cost: 0,
    blurb: "Little coherent policy; volatility and leakage.",
  },
];
...
const LABOR: ForgeChoice[] = [
  ...
  {
    id: "labor-improvised",
    label: "Underfunded labor order (ad hoc)",
    cost: 0,
    blurb: "Rights and enforcement unclear; friction and risk.",
  },
];
...
const EDUCATION: ForgeChoice[] = [
  {
    id: "edu-0",
    label: "Underfunded education (informal only)",
    cost: 0,
    blurb: "No real system; bank points, lose human-capital edge.",
  },
...
const INFRASTRUCTURE: ForgeChoice[] = [
  {
    id: "infra-0",
    label: "Underfunded infrastructure (fragmented)",
    cost: 0,
    blurb: "Rolling blackouts, bad roads; you kept the points.",
  },
...
const FOREIGN: ForgeChoice[] = [
  {
    id: "for-uncommitted",
    label: "Uncommitted foreign posture (reactive)",
    cost: 0,
    blurb: "No clear doctrine; surprises from abroad.",
  },
...
const DEMOGRAPHICS: ForgeChoice[] = [
  {
    id: "demo-unsettled",
    label: "Unsettled population policy (underfunded)",
    cost: 0,
    blurb: "No budget for integration or closure; social friction.",
  },
...
const CULTURAL: ForgeChoice[] = [
  {
    id: "cul-unsettled",
    label: "No dominant cultural project (underfunded)",
    cost: 0,
    blurb: "Civic story stays weak; cohesion suffers.",
  },
...
/** Affordable choices first, then by ascending cost (helps when budget is tight). */
export function choicesOrderedForBudget(
  stepId: ForgeStepId,
  ...
  return [...list].sort((a, b) => {
    const aOk = a.cost <= pointsRemaining;
    const bOk = b.cost <= pointsRemaining;
